...
Replace this section with the supported versions for `envprobe`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `envprobe` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in envprobe.
